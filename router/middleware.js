...
var checkuser = function(req, res, next){
     if((typeof req.session.userid === 'undefined') || req.session.userid === null){
         res.render('pages/user', {msg: "Unable to find your user ID"});
     }
...
var finduserAndCategories = function(req, res, next){
    global.db.User.find({where: {id: req.session.userid}})
    .then(function(u){
        if (u){
            req.user = u;
...
module.exports.finduserAndCategories = finduserAndCategories;
